            ...
            <div className={style['articleaside']}>
              <div className={style.container__md}>
                ...
                <p className={style['articleaside__desc']}>
                  ...
                  non fringilla dignissim ac risus amet eget egestas vestibulum.
          ...
          <div className={style['grid']}>
            <div className={style['about__main']}>
              ...
              <p className={style['about__main__desc']}>
                ...
                knowledge and expertise to create unique and comfortable
                interiors for you. Our team knows that interior design can be
                stressful for the client and we do our best to make it as easy
                as possible. We listen to your needs, ideas, and inputs. And
                most importantly, we make it exciting and enjoyable for our
                clients. <br /> <br /> Interiart is an award-winning
                architecture and interior design practice based in NYC. We work
                internationally on projects of residential & commercial interior
                design that require a creative approach. Our talented and our
                best to make it as easy as possible. We listen to your needs,
                ideas, and inputs. <br /> <br />
                And most importantly, we make it exciting and enjoyable for our
                clients. Interiart is an award-winning architecture and interior
                design practice based in NYC. We work internationally on
                projects of residential & commercial interior design that
                ...
                ideas, and inputs. And most importantly, we make it exciting and
